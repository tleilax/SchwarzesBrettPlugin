<a href="#" onClick="closeArtikel(this);return false;">
	...
	<div align="right" style="font-size:smaller; padding:1px 0px 5px 0px;">
		erstellt von <a href="<?=URLHelper::getLink('about.php')?>&username=<?=get_username($a->getUserId())?>"><?=get_fullname($a->getUserId())?></a> | gültig bis bis <?=date("d.m.Y",$a->getMkdate()+$zeit)?>
	</div>
